  ...
  return (
    <div className=" my-8">
      <div className="container">
        ...
        {/* <div className="grid xl:grid-cols-2 lg:grid-cols-2 md:grid-cols-2 grid-cols-1 gap-7 pt-10">
          {instructorData.map((item, index) => (
            ...
            >
              <Link to={item.link}>
              <div className=" team-card rounded-t-md  relative mx-auto  overflow-hidden">
                <img
                  src={item.img}
                  alt=""
